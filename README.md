...
| `docs/`           | Working reference (numbered `04`–`32`) + `whitepaper/` (narrative deliverable) + `annotations/` (per-field register meaning) + `findings/` (rule engine). Highlights: `11` (attribute catalog), `31` (deepening plan, Phases 1–5), `32` (first-contact troubleshooting). Start at `docs/README.md`. |
